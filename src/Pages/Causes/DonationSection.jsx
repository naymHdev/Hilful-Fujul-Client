const DonationSection = () => {
  ...
  return (
    <div className=" rounded-3xl shadow-lg px-6 py-5">
      <div className="">
      ...
      <div className=" mt-4">
        <button className="w-full bg-yellow-400 text-black font-bold py-3 px-4 rounded-xl mb-2">
          Share
        </button>
        <button className="w-full bg-orange-400 text-black font-bold py-3 px-4 rounded-xl mb-6">
          Donate now
        </button>
      </div>
    </div>
